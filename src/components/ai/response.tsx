...
import { ComponentPropsWithoutRef, isValidElement, memo, ReactNode } from 'react';
...
const components: Partial<Components> = {
	ol: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'ol'>) => (
	...
	li: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'li'>) => (
	...
	ul: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'ul'>) => (
		<ul className={cn('ml-4 list-outside list-disc', className)} {...props}>
			{children}
		</ul>
	),
	hr: ({ node, className, ...props }: MarkdownComponentProps & ComponentPropsWithoutRef<'hr'>) => (
	...
	strong: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'strong'>) => (
	...
	a: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'a'>) => (
		<a
	...
	h1: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h1'>) => (
	...
	h2: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h2'>) => (
	...
	h3: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h3'>) => (
	...
	h4: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h4'>) => (
	...
	h5: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h5'>) => (
	...
	h6: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'h6'>) => (
	...
	table: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'table'>) => (
	...
	thead: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'thead'>) => (
	...
	tbody: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'tbody'>) => (
	...
	tr: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'tr'>) => (
	...
	th: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'th'>) => (
	...
	td: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'td'>) => (
	...
	blockquote: ({
		...
		className,
		...props
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'blockquote'>) => (
		<blockquote
			className={cn(
	...
	pre: ({
		...
		className,
		children,
	}: MarkdownComponentProps & ComponentPropsWithoutRef<'pre'>) => {
